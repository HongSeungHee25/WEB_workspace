 ...
 */
	...
	static {   //변수들이 static 영역에 저장됩니다.sqlSessionFactory 를 static 으로 만들기 위함.
		...
		sqlSessionFactory = new SqlSessionFactoryBuilder().build(inputStream);   		//실제 db연결이 성공했을 때 정상적으로 객체가 생성.
		//읽어온 파일로 factory 생성
	}
