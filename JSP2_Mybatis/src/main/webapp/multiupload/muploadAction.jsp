...
<% 
	...
	/* enums에 다음값이 있으면 true 없으면 false */
	while (fileNames.hasMoreElements()) {
    String paramName = (String) fileNames.nextElement();	//iterator 처럼 하나씩 가져오기. 리턴은 요소의 name 속성값
    picture.append(multiRequest.getFilesystemName(paramName)).append(","); 	//해당 속성값의 파일을 업로드. 문자열에 추가
	...
	ProductDTO dto = new ProductDTO(
			pname,Integer.parseInt(price), null, picture.toString());
