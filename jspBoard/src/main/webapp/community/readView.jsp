...
<body>
			...
			<li id="content">
				<ul>
					...
					<!-- textarea 에 입력한 엔터는 \n db 에도 \n 으로 저장됩니다. (=> textarea 는 글쓰기, 글수정에서 사용할 입력 태그.)
						html 문서 출력은 줄바꿈은 <br> 태그로 변경되어야 하는데 해결방법 1) pre태그, 방법2) \n 을 <br>로 대치 방법2)는
						줄바꿈 외에도 여러가지 메타문자들이 대치되어야 하지만 pre 태그 안에서는 모든 문자들을 그대로 출력시킴 -->
					<li>
   ...
   <form action="commentsAction.jsp" method="post">
   	<!-- 필요한 파라미터. 화면에는 표시안함. -->
   	...
   	<ul>
   		...
   		<li>
   			<ul style="display: flex;">
   				<li>
   					<textarea rows="5" cols="80" name="content" style="resize: none;margin-right: 20px;" placeholder="로그인 후에 댓글을 작성하세요." class="input"></textarea>
   				</li>
   		...
   		<li>
   			...
   			<!-- session 에 저장된 user 애트리뷰트의 id와 작석자의 id가 같으면 삭제버튼 보이기 -->
